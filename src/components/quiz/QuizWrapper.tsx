...
const QuizWrapper = () => {
    ...
    return (
        <>
            <main className='grid place-items-center min-h-screen py-10' style={{ minHeight: '100dvh' }}>
                <div className='max-w-xl w-full'>
                    ...
                    {questions.length > 0 && !isQuizOver && <QuestionCard questions={questions} currentQuestion={currentQuestion} readyForNext={readyForNext} handleNext={handleNext} />}
